...
client.on('message', message => {
    ...
    .setURL(`https://discordapp.com/oauth2/authorize?client_id=529791622448152596&scope=bot&permissions=2146958847&response_type=code`)  // حط اي دي بوتك
...
client.on('message', message => {
    if (message.author.bot) return;
     if (message.content === prefix + "Metagaming") {
 ...
 message.author.sendMessage(`
 **MG – Meta Gaming =
هي خلط معلومات  ic و  ooc 
معا والعكس صحيح . 
بمعني : 
ان ال 
ic = هي التكلم بواقعيه وكانك بالحقيقه . وبتتكلم منها من 
(T) وبتكتب الكلام . 
مثال : 
T يا صاح كيف حالك اليوم 
T يا صاح تعرف اين مركز الشرطه لاقوم بعمل بلاغ 
ooc = هي التكلم بخارج الواقعيه وتخص مشكله باللعبه او شئ او التكلم مع ادمن . او السؤال عن شئ خارج الاربي او خارج اللعبه . 
(B) وبتكتب الكلام .
مثال : 
B يا ادمن . يوجد مشكله بالسياره تجعلني لا استطيع اللعب بها للاربي  .
B يا ادمن يوجد شخص يخرب الاربي عن قصد . 
امتي يكون ميتا جمينج وهل عليها عقاب ؟ 
ميتا جمينج ديه عليها عقاب لان المفروض انك تتكلم في 
T في اوقاتها 
B في اوقاتها زي الشرح ال فوق 
ولو عكست عن قصد بيبقي ليه عقاب وكل سيرفر وليه طريقه عقاب في السجن الادمن وده سجن غير واقعي . 
وفي عن طريق التحذير .
مثال ل ميتا جمينج : 
T = يا ادمن . 
B = اين معرض بيع الدراجات الناريه . 
وطبعا ده غلط .  
ومثال اخر عن طريق الخاص : 
يعني تكلم شخص خاص وتقول له اين انت بيبقي كده ميتا جمينج وممنوع
**`);
